...
## 🔍 Features
- ✅ Scrapes fragrance data (notes, accord types, reviews) from Fragrantica
...
## 🚧 In Progress
- [ ] Clean and unify scraped fragrance note data
- [ ] Build note embeddings and similarity engine
- [ ] Add seasonal classification model
- [ ] Build a lightweight UI (Streamlit or Flask)
- [ ] Deploy to web for live demos
